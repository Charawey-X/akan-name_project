...
let yourday =["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"];
...
function computeName() {
    ...
    if ((!!dayOfWeek.valueOf() === true) || (dayOfWeek == 0))  {
        if (selectedGender === 0) {
            let result = "Your day is " + yourday[dayOfWeek] + "." + "<br>" + "Your Akan name is " + maleNames[dayOfWeek] + ".";
            document.getElementById("result").innerHTML = result;
        } else if (selectedGender === 1) {
            let result = "Your  day is " + yourday[dayOfWeek] + "." + " <br>" + "Your Akan name is " +  femaleNames[dayOfWeek] + ".";
            document.getElementById("result").innerHTML = result;
        }
    }else{
        return;
